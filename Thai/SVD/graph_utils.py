...
def create_vertices(corpus: list, k: int) -> dict:
    ...
    Returns dict = {word: Node(vector,
                               empty set)}
    '''
    file_ = open(f'th_create_vertices_progress_SVD.txt', 'w')
    vertices = dict()
...
class Parallel(Graph):
    ...
    def parallel_gabriel_graph(self, index: int) -> dict:
        ...
        '''
        file_ = open(f"th_gabriel_progress_{index}_SVD.txt", 'w')
...
class GG(Graph):
    ...
    def create_delaunay_graph(self):
        ...
        file_ = open('th_delaunay_progress_SVD.txt', 'w')
    ...
    def create_gabriel_graph(self):
        ...
        file_ = open('th_gabriel_progress_SVD.txt', 'w')
    ...
    def create_parallel_gabriel_graph(self, triangles: list, num_cpus: int = 1):
        ...
        file_ = open('th_stream_create_progress_SVD.txt', 'w')
        ...
        ray.shutdown()
        file_ = open('th_merge_streams_progress_SVD.txt', 'w')
