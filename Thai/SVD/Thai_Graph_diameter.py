...
def main():
    ...
    with open('/home/fgazzavi/f_env/Thai/SVD/Diamter_SVD.txt', 'a',encoding='utf-8') as f:
        f.write(f"SVD weighted diameter is : {wd}\n")
        f.write(f"SVD Average weighted Shortest paths is : {awsp}\n")
    # print ("CBOW")
    # with open('/home/fgazzavi/f_env/Thai/SVD/Thai_Gabriel_Graph_sample1%_SVD_1gram_6.pkl', 'rb') as inp:
    ...
    # print(degree_dic)
    # with open('/home/fgazzavi/f_env/Thai/SVD/Thai_degree_SVD_1gram_6_ig.pkl', 'wb') as outp:
    ...
    #     cc_dic_w[key] = value
    # print(cc_dic_w)
    # with open('/home/fgazzavi/f_env/Thai/SVD/Thai_CCW_SVD_1gram_6_ig.pkl', 'wb') as outp:
    ...
    #     cc_dic[key] = value
    # print(cc_dic)
    # with open('/home/fgazzavi/f_env/Thai/SVD/Thai_CC_SVD_1gram_6_ig.pkl', 'wb') as outp:
    ...
    #     bc_dic[key] = value
    # print(bc_dic)
    # with open('/home/fgazzavi/f_env/Thai/SVD/Thai_BC_SVD_1gram_6_ig.pkl', 'wb') as outp:
    ...
    #     bc_dic_w[key] = value
    # print(bc_dic_w)
    # with open('/home/fgazzavi/f_env/Thai/SVD/Thai_BCW_SVD_1gram_6_ig.pkl', 'wb') as outp:
    #     pickle.dump(bc_dic_w, outp, pickle.HIGHEST_PROTOCOL)

    # with open('/home/fgazzavi/f_env/Thai/SVD/Thai_Gabriel_Graph_sample1%_SVD_1gram_6_ig.pkl', 'wb') as outp:
