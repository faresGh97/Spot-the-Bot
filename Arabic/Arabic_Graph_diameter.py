...
def main():
    ...
    with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Diamter_CBOW.txt', 'a',encoding='utf-8') as f:
    ...
    wd = graph.diameter(weights="weight")
    awsp = np.mean(graph.shortest_paths(weights="weight"))
    with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Diamter_SVD.txt', 'a',encoding='utf-8') as f:
        f.write(f"SVD weighted diameter is : {wd}\n")
        f.write(f"SVD Average weighted Shortest paths is : {awsp}\n")

        
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_Gabriel_Graph_sample1%_CBOW_1gram_6.pkl', 'rb') as inp:
    ...
    # print(degree_dic)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_degree_CBOW_1gram_6_ig.pkl', 'wb') as outp:
    ...
    #     cc_dic_w[key] = value
    # print(cc_dic_w)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_CCW_CBOW_1gram_6_ig.pkl', 'wb') as outp:
    ...
    #     cc_dic[key] = value
    # print(cc_dic)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_CC_CBOW_1gram_6_ig.pkl', 'wb') as outp:
    ...
    #     bc_dic[key] = value
    # print(bc_dic)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_BC_CBOW_1gram_6_ig.pkl', 'wb') as outp:
    ...
    #     bc_dic_w[key] = value
    # print(bc_dic_w)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_BCW_CBOW_1gram_6_ig.pkl', 'wb') as outp:
    #     pickle.dump(bc_dic_w, outp, pickle.HIGHEST_PROTOCOL)

    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_Gabriel_Graph_sample1%_CBOW_1gram_6_ig.pkl', 'wb') as outp:
    #     pickle.dump(graph, outp, pickle.HIGHEST_PROTOCOL)

    # print ("SVD")
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_Gabriel_Graph_sample1%_SVD_1gram_6.pkl', 'rb') as inp:
    #     At_graph_cbow_1g6 = pickle.load(inp)
    ...
    #     degree_dic[key] = value
    # print(degree_dic)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_degree_SVD_1gram_6_ig.pkl', 'wb') as outp:
    #     pickle.dump(degree_dic, outp, pickle.HIGHEST_PROTOCOL)
    ...
    #     cc_dic_w[key] = value
    # print(cc_dic_w)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_CCW_SVD_1gram_6_ig.pkl', 'wb') as outp:
    #     pickle.dump(cc_dic_w, outp, pickle.HIGHEST_PROTOCOL)
    ...
    #     cc_dic[key] = value
    # print(cc_dic)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_CC_SVD_1gram_6_ig.pkl', 'wb') as outp:
    #     pickle.dump(cc_dic, outp, pickle.HIGHEST_PROTOCOL)
    ...
    #     bc_dic[key] = value
    # print(bc_dic)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_BC_SVD_1gram_6_ig.pkl', 'wb') as outp:
    #     pickle.dump(bc_dic, outp, pickle.HIGHEST_PROTOCOL)
    ...
    #     bc_dic_w[key] = value
    # print(bc_dic_w)
    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_BCW_SVD_1gram_6_ig.pkl', 'wb') as outp:
    #     pickle.dump(bc_dic_w, outp, pickle.HIGHEST_PROTOCOL)

    # with open('/home/fgazzavi/f_env/Arabic/Arabic_nk/Arabic_Gabriel_Graph_sample1%_SVD_1gram_6_ig.pkl', 'wb') as outp:
    #     pickle.dump(graph, outp, pickle.HIGHEST_PROTOCOL)
