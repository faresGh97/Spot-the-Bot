...
def create_vertices(corpus: list, k: int) -> dict:
    ...
    Returns dict = {word: Node(vector,
                               empty set)}
    '''
    file_ = open(f'Ru_create_vertices_progress.txt', 'w')
    vertices = dict()
...
class GG(Graph):
    ...
    def create_delaunay_graph(self):
        ...
        file_ = open('Ru_delaunay_progress.txt', 'w')
    ...
    def create_gabriel_graph(self):
        ...
        file_ = open('ru_gabriel_progress.txt', 'w')
    ...
    def create_parallel_gabriel_graph(self, triangles: list, num_cpus: int = 1):
        ...
        file_ = open('ru_stream_create_progress.txt', 'w')
        ...
        ray.shutdown()
        file_ = open('ru_merge_streams_progress.txt', 'w')
