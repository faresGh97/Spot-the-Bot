...
def create_vertices(corpus: list, k: int) -> dict:
    ...
    Returns dict = {word: Node(vector,
                               empty set)}
    '''
    file_ = open(f'en_create_vertices_progress.txt', 'w')
    vertices = dict()
...
class Parallel(Graph):
    ...
    def parallel_gabriel_graph(self, index: int) -> dict:
        ...
        '''
        file_ = open(f"en_gabriel_progress_{index}.txt", 'w')
...
class GG(Graph):
    ...
    def create_gabriel_graph(self):
        ...
        file_ = open('eng_gabriel_progress.txt', 'w')
    ...
    def create_parallel_gabriel_graph(self, triangles: list, num_cpus: int = 1):
        ...
        file_ = open('eng_stream_create_progress.txt', 'w')
        ...
        ray.shutdown()
        file_ = open('eng_merge_streams_progress.txt', 'w')
