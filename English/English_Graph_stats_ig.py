...
def main():
    ...
    # plt.legend()
    # plt.savefig('English_Weighted_path_length_CBOW_500.pdf')
    # plt.clf()
    #plt.show()
    ...
    plt.legend()
    plt.savefig('English_Weighted_cc_CBOW_500.pdf')
    plt.clf()
    ...
    plt.legend()
    plt.savefig('English_Weighted_bc_CBOW_500.pdf')
    plt.clf()
    ...
    # plt.title("Weighted path length for texts generated by humans and bots")
    # plt.legend()
    # plt.savefig('English_Weighted_path_length_SVD_500.pdf')
    # plt.clf()
    #plt.show()
    ...
    plt.title("Weighted closness Centrality for texts generated by humans and bots")
    plt.legend()
    plt.savefig('English_Weighted_cc_SVD_500.pdf')
    plt.clf()
    ...
    plt.title("Weighted betweeness centrality for texts generated by humans and bots")
    plt.legend()
    plt.savefig('English_Weighted_bc_SVD_500.pdf')
    plt.clf()
